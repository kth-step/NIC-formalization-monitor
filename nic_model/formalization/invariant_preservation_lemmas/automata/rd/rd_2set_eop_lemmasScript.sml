...
val _ = new_theory "rd_2set_eop_lemmas";
...
val rd_2set_eop_cppi_ram_write_step_bd_pas_case_def = Define `
  (rd_2set_eop_cppi_ram_write_step_bd_pas_case T T _ nic = [(set_eop, nic.rx.current_bd_pa)]) /\
  (rd_2set_eop_cppi_ram_write_step_bd_pas_case T F T nic = [(set_eoq, nic.rx.current_bd_pa)]) /\
  (rd_2set_eop_cppi_ram_write_step_bd_pas_case T F F nic = [(set_td, nic.rx.current_bd_pa)]) /\
  (rd_2set_eop_cppi_ram_write_step_bd_pas_case F _ _ nic = [])`;

val rd_2set_eop_cppi_ram_write_step_bd_pas_def = Define `
  rd_2set_eop_cppi_ram_write_step_bd_pas env nic =
  rd_2set_eop_cppi_ram_write_step_bd_pas_case
  (RD_WRITE_CURRENT_BD_PA nic)
  env.rd.set_eop
  env.rd.set_eoq
  nic`;

val rd_2set_eop_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma = store_thm (
  "rd_2set_eop_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma",
  ``!nic env.
  ...
  REWRITE_TAC [rd_2set_eop_cppi_ram_write_step_bd_pas_def] THEN
  REWRITE_TAC [rd_2set_eop_def, rd_3set_eoq_def, rd_4set_td_def, rd_5clear_owner_and_hdp_def] THEN
  ASM_CASES_TAC ``RD_WRITE_CURRENT_BD_PA nic`` THEN
  ASM_CASES_TAC ``env.rd.set_eop`` THEN
  ASM_CASES_TAC ``env.rd.set_eoq`` THEN
  ASM_REWRITE_TAC [rd_2set_eop_cppi_ram_write_step_bd_pas_case_def] THEN
...
val rd_2set_eop_cppi_ram_write_step_bd_pas_IN_RX_CURRENT_BD_PA_lemma = store_thm (
  "rd_2set_eop_cppi_ram_write_step_bd_pas_IN_RX_CURRENT_BD_PA_lemma",
  ``!nic env.
    IN_LIST1_IMP_IN_LIST2
    (MAP SND (rd_2set_eop_cppi_ram_write_step_bd_pas env nic))
...
val rd_2set_eop_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma = store_thm (
  "rd_2set_eop_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma",
  ``!nic env.
  ...
  REWRITE_TAC [rd_2set_eop_cppi_ram_write_step_bd_pas_IN_RX_CURRENT_BD_PA_lemma]);
...
val rd_2set_eop_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma = store_thm (
  "rd_2set_eop_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma",
  ``!nic env.
    PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION (rd_2set_eop_cppi_ram_write_step_bd_pas env nic)``,
  REPEAT GEN_TAC THEN
...
val rd_2set_eop_WRITES_FIELDs_NOT_NDP_OF_BD_AT_CURRENT_BD_PA_lemma = store_thm (
  ...
  REWRITE_TAC [rd_2set_eop_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma] THEN
  REWRITE_TAC [rd_2set_eop_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma] THEN
  REWRITE_TAC [rd_2set_eop_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma]);
...
val rd_2set_eop_ESTABLISHES_RD_INVARIANT_RD_CLEARS_BD_QUEUE_lemma = store_thm (
  "rd_2set_eop_ESTABLISHES_RD_INVARIANT_RD_CLEARS_BD_QUEUE_lemma",
  ``!nic env nic'.
    (nic' = rd_2set_eop env nic)
    ==>
...
val rd_2set_eop_NEXT_STATE_NOT_RD_WRITE_CP_OR_CLEAR_RX_SOP_BD_PA_AND_NEXT_STATE_RX_IDLE_lemma = store_thm (
...
val rd_2set_eop_IMP_NOT_NEXT_RD_STATE_IDLE_lemma = store_thm (
