...
val _ = new_theory "rd_5clear_owner_and_hdp_lemmas";
...
val rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_case_def = Define `
  (rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_case T nic =
   [(clear_own, nic.rx.current_bd_pa)]) /\
  (rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_case F nic =
   [])`;

val rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_def = Define `
  rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas nic =
  rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_case (RD_WRITE_CURRENT_BD_PA nic) nic`;

val rd_5clear_owner_and_hdp_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma = store_thm (
  "rd_5clear_owner_and_hdp_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma",
  ``!nic.
    NIC_DELTA_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs
    (rd_5clear_owner_and_hdp)
    nic
    (rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas nic)``,
  GEN_TAC THEN
  REWRITE_TAC [NIC_DELTA_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_def] THEN
  REWRITE_TAC [rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_def] THEN
  REWRITE_TAC [rd_5clear_owner_and_hdp_def] THEN
  ASM_CASES_TAC ``RD_WRITE_CURRENT_BD_PA nic`` THEN
  ASM_REWRITE_TAC [rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_case_def] THEN
...
val rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_IN_RX_CURRENT_BD_PA_lemma = store_thm (
  "rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_IN_RX_CURRENT_BD_PA_lemma",
  ``!nic.
    IN_LIST1_IMP_IN_LIST2
    (MAP SND (rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas nic))
...
val rd_5clear_owner_and_hdp_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma = store_thm (
  "rd_5clear_owner_and_hdp_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma",
  ``!nic.
  ...
  REWRITE_TAC [rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas_IN_RX_CURRENT_BD_PA_lemma]);

val rd_5clear_owner_and_hdp_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma = store_thm (
  "rd_5clear_owner_and_hdp_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma",
  ``!nic.
    PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION (rd_5clear_owner_and_hdp_cppi_ram_write_step_bd_pas nic)``,
  GEN_TAC THEN
...
val rd_5clear_owner_and_hdp_WRITES_FIELDs_NOT_NDP_OF_BD_AT_CURRENT_BD_PA_lemma = store_thm (
  ...
  REWRITE_TAC [rd_5clear_owner_and_hdp_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma] THEN
  REWRITE_TAC [rd_5clear_owner_and_hdp_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma] THEN
  REWRITE_TAC [rd_5clear_owner_and_hdp_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma]);



val rd_5clear_owner_and_hdp_ESTABLISHES_RD_INVARIANT_RD_CLEARS_BD_QUEUE_lemma = store_thm (
  "rd_5clear_owner_and_hdp_ESTABLISHES_RD_INVARIANT_RD_CLEARS_BD_QUEUE_lemma",
  ``!nic nic'.
    (nic' = rd_5clear_owner_and_hdp nic)
    ==>
...
val rd_5clear_owner_and_hdp_NEXT_STATE_NOT_RD_WRITE_CP_OR_CLEAR_RX_SOP_BD_PA_AND_NEXT_STATE_RX_IDLE_lemma = store_thm (
...
val rd_with_rw_tactic =
  rw_state_tactic
  `r0`
  [stateTheory.rd_state_fn_updates, combinTheory.K_THM, stateTheory.rd_state_accessors];

val rd_5clear_owner_and_hdp_IMP_NOT_NEXT_RD_STATE_IDLE_lemma = store_thm (
