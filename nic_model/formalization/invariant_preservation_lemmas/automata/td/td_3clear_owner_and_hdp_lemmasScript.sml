...
val _ = new_theory "td_3clear_owner_and_hdp_lemmas";

val td_3clear_owner_and_hdp_cppi_ram_write_step_bd_pas_def = Define `
  td_3clear_owner_and_hdp_cppi_ram_write_step_bd_pas nic =
  if TD_WRITE_CURRENT_BD_PA nic then
    [(clear_own, nic.tx.current_bd_pa)]
  else
    []`;

val td_3clear_owner_and_hdp_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma = store_thm (
...
val td_3clear_owner_and_hdp_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma = store_thm (
  ...
  REWRITE_TAC [td_3clear_owner_and_hdp_cppi_ram_write_step_bd_pas_def, listTheory.MAP] THEN
  COND_CASES_TAC THEN
  REWRITE_TAC [listTheory.MAP, IN_LIST1_IMP_IN_LIST2_REFL_lemma, IN_EMPTY_LIST_IMP_IN_LIST_lemma]);

val td_3clear_owner_and_hdp_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma = store_thm (
  "td_3clear_owner_and_hdp_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma",
  ``!nic. PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION (td_3clear_owner_and_hdp_cppi_ram_write_step_bd_pas nic)``,
  GEN_TAC THEN
  ...
  REWRITE_TAC [clear_own_lemmasTheory.clear_own_CPPI_RAM_WRITE_STEP_WRITES_BD_AND_PRESERVES_NDP_lemma]);

val td_3clear_owner_and_hdp_WRITES_FIELDs_NOT_NDP_OF_BD_AT_CURRENT_BD_PA_lemma = store_thm (
  "td_3clear_owner_and_hdp_WRITES_FIELDs_NOT_NDP_OF_BD_AT_CURRENT_BD_PA_lemma",
  ``!nic.
  ...
  REWRITE_TAC [td_3clear_owner_and_hdp_CPPI_RAM_WRITE_EQ_CPPI_RAM_WRITE_STEP_BD_PAs_lemma] THEN
  REWRITE_TAC [td_3clear_owner_and_hdp_CPPI_RAM_WRITE_STEPs_WRITE_BD_AT_CURRENT_BD_PA_lemma] THEN
  REWRITE_TAC [td_3clear_owner_and_hdp_PRESERVES_NON_OVERLAPPING_BD_QUEUE_LOCATION_lemma]);
...
val td_3clear_owner_and_hdp_REVERSE_PRESERVED_TX_STATE_IDLE_lemma = store_thm (
  "td_3clear_owner_and_hdp_REVERSE_PRESERVED_TX_STATE_IDLE_lemma",
  ``!nic.
    TX_STATE_IDLE (td_3clear_owner_and_hdp nic)
    ==>
    TX_STATE_IDLE nic``,
  GEN_TAC THEN
...
val td_3clear_owner_and_hdp_REVERSE_PRESERVED_TD_WRITE_CURRENT_BD_PA_lemma = store_thm (
  "td_3clear_owner_and_hdp_REVERSE_PRESERVED_TD_WRITE_CURRENT_BD_PA_lemma",
  ``!nic.
    TD_WRITE_CURRENT_BD_PA (td_3clear_owner_and_hdp nic)
    ==>
...
val td_3clear_owner_and_hdp_REVERSE_PRESERVED_TD_STATE_WRITE_CPPI_RAM_lemma = store_thm (
  "td_3clear_owner_and_hdp_REVERSE_PRESERVED_TD_STATE_WRITE_CPPI_RAM_lemma",
  ``NIC_DELTA_REVERSE_PRESERVED_TD_STATE_WRITE_CPPI_RAM td_3clear_owner_and_hdp``,
  REWRITE_TAC [NIC_DELTA_REVERSE_PRESERVED_TD_STATE_WRITE_CPPI_RAM_def] THEN
  GEN_TAC THEN
  REWRITE_TAC [TD_STATE_WRITE_CPPI_RAM_def] THEN
  DISCH_TAC THEN
  SPLIT_ASM_TAC THEN
  ASSUME_TAC (UNDISCH (SPEC_ALL td_3clear_owner_and_hdp_REVERSE_PRESERVED_TX_STATE_IDLE_lemma)) THEN
  ASSUME_TAC (UNDISCH (SPEC_ALL td_3clear_owner_and_hdp_REVERSE_PRESERVED_TD_WRITE_CURRENT_BD_PA_lemma)) THEN
  ASM_REWRITE_TAC []);
...
val td_3clear_owner_and_hdp_TD_WRITE_CURRENT_BD_PA_NEQ_ZERO_IMP_PRESERVES_TX_CURRENT_BD_PA_lemma = store_thm (
  "td_3clear_owner_and_hdp_TD_WRITE_CURRENT_BD_PA_NEQ_ZERO_IMP_PRESERVES_TX_CURRENT_BD_PA_lemma",
  ``NIC_DELTA_TD_WRITE_CURRENT_BD_PA_NEQ_ZERO_IMP_PRESERVES_TX_CURRENT_BD_PA td_3clear_owner_and_hdp``,
...
val td_3clear_owner_and_hdp_PRESERVES_TX_STATE_IT_RX_RD_lemma = store_thm (
  "td_3clear_owner_and_hdp_PRESERVES_TX_STATE_IT_RX_RD_lemma",
  ``NIC_DELTA_PRESERVES_TX_STATE td_3clear_owner_and_hdp /\
    NIC_DELTA_PRESERVES_IT td_3clear_owner_and_hdp /\
    NIC_DELTA_PRESERVES_RX td_3clear_owner_and_hdp /\
    NIC_DELTA_PRESERVES_RD td_3clear_owner_and_hdp``,
...
val td_3clear_owner_and_hdp_PRESERVES_DEAD_lemma = store_thm (
  "td_3clear_owner_and_hdp_PRESERVES_DEAD_lemma",
  ``!nic nic'.
    (nic' = td_3clear_owner_and_hdp nic)
    ==>
    (nic'.dead = nic.dead)``,
  REPEAT GEN_TAC THEN
  DISCH_TAC THEN
...
val td_3clear_owner_and_hdp_PRESERVES_RX_BUFFER_OFFSET_lemma = store_thm (
...
val td_3clear_owner_and_hdp_NOT_TD_WRITE_CURRENT_BD_PA_IMP_PRESERVES_CPPI_RAM_lemma = store_thm (
